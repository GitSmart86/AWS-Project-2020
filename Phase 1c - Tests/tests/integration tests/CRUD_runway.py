...
from classes.models import Runway
import datetime

NOW = datetime.datetime.now()

class CRUD_runway_IntegrationTestCases(TestCase):
    def setUp(self):
    ...
    def test_create_edit_delete(self):
        ...
        # TEST - Delete
        response = c.post(f'/runway/{test_item.id}/delete')
        try:
